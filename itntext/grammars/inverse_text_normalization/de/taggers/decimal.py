import pynini
from itntext.grammars.text_normalization.de.taggers.decimal import get_quantity, quantities
from itntext.grammars.text_normalization.en.graph_utils import DAMO_SIGMA, GraphFst
