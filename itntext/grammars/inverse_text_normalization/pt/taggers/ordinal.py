import pynini
from itntext.grammars.inverse_text_normalization.pt.utils import get_abs_path
from itntext.grammars.text_normalization.en.graph_utils import DAMO_SIGMA, GraphFst, delete_space
