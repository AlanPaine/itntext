...
from itntext.grammars.text_normalization.data_loader_utils import load_file, write_file
from itntext.grammars.text_normalization.normalize import Normalizer
from itntext.grammars.text_normalization.token_parser import TokenParser
...
class InverseNormalizer(Normalizer):
    ...
    def __init__(
        ...
        if lang == "en":
            ...
            from itntext.grammars.inverse_text_normalization.tl.taggers.tokenize_and_classify import (
                ClassifyFst,
            )
            from itntext.grammars.inverse_text_normalization.tl.verbalizers.verbalize_final import (
                VerbalizeFinalFst,
            )
