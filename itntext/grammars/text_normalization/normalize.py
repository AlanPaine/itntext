...
from itntext.grammars.text_normalization.data_loader_utils import (
    load_file,
    post_process_punct,
    pre_process,
    write_file,
)
from itntext.grammars.text_normalization.token_parser import PRESERVE_ORDER_KEY, TokenParser
...
class Normalizer:
    ...
    def __init__(
        ...
        if lang == "en":
            from itntext.grammars.text_normalization.en.verbalizers.verbalize_final import (
                VerbalizeFinalFst,
            )
            from itntext.grammars.text_normalization.en.verbalizers.post_processing import (
                PostProcessingFst,
            )
            ...
            if deterministic:
                from itntext.grammars.text_normalization.en.taggers.tokenize_and_classify import (
                    ClassifyFst,
                )
            else:
                if lm:
                    from itntext.grammars.text_normalization.en.taggers.tokenize_and_classify_lm import (
                        ClassifyFst,
                    )
                else:
                    from itntext.grammars.text_normalization.en.taggers.tokenize_and_classify_with_audio import (
                        ClassifyFst,
                    )
            ...
            from itntext.grammars.text_normalization.ru.taggers.tokenize_and_classify import (
                ClassifyFst,
            )
            from itntext.grammars.text_normalization.ru.verbalizers.verbalize_final import (
                VerbalizeFinalFst,
            )
        elif lang == "de":
            from itntext.grammars.text_normalization.de.taggers.tokenize_and_classify import (
                ClassifyFst,
            )
            from itntext.grammars.text_normalization.de.verbalizers.verbalize_final import (
                VerbalizeFinalFst,
            )
        elif lang == "es":
            from itntext.grammars.text_normalization.es.taggers.tokenize_and_classify import (
                ClassifyFst,
            )
            from itntext.grammars.text_normalization.es.verbalizers.verbalize_final import (
                VerbalizeFinalFst,
            )
        elif lang == "zh":
            from itntext.grammars.text_normalization.zh.taggers.tokenize_and_classify import (
                ClassifyFst,
            )
            from itntext.grammars.text_normalization.zh.verbalizers.verbalize_final import (
                VerbalizeFinalFst,
            )
