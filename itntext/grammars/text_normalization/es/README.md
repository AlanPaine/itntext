...
To toggle the alternate formatting, you may edit the `LOCALIZATION` variable in `itntext.grammars.text_normalization.es.__init__` with the value of `'am'`. This will perform necessary
