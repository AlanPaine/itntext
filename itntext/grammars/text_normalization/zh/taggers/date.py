import pynini
from itntext.grammars.text_normalization.zh.graph_utils import (
    FUN_CHAR,
    FUN_DIGIT,
    GraphFst,
    insert_space,
)
from itntext.grammars.text_normalization.zh.utils import get_abs_path
...
class Date(GraphFst):
    ...
    def __init__(self, deterministic: bool = True, lm: bool = False):
        ...
        month_zh = pynini.closure(FUN_DIGIT, 1, 2) + pynutil.delete("月")
        day_zh = pynini.closure(FUN_DIGIT, 1, 2) + (pynutil.delete("日") | pynutil.delete("号"))
        ...
        graph = date_type5 | date_type6 | date_type0 | date_type1 | date_type2 | date_type3 | date_type4
