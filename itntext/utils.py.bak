...
def get_abs_path(rel_path):
    """
    Get absolute path relative to itntext package root.

    Args:
        rel_path: relative path from itntext/ directory

    Returns absolute path
    """
    # Normalize paths like "../itn/chinese/data/..." to "itn/chinese/data/..."
    # since utils.py is at itntext/utils.py, and ../itn/ from utils.py = itntext/../itn/ = itn/
    # but data is actually at itntext/itn/chinese/data/
    # So we need to handle the ../ prefix specially
