...
class Cardinal(Processor):
    ...
    def build_tagger(self):
        zero = string_file(get_abs_path("tn/chinese/data/number/zero.tsv"))
        digit = string_file(get_abs_path("tn/chinese/data/number/digit.tsv"))
        teen = string_file(get_abs_path("tn/chinese/data/number/teen.tsv"))
        sign = string_file(get_abs_path("tn/chinese/data/number/sign.tsv"))
        dot = string_file(get_abs_path("tn/chinese/data/number/dot.tsv"))
        ...
        phone = string_file(get_abs_path("tn/chinese/data/cardinal/phone.tsv"))
