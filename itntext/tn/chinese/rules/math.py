...
from itntext.tn.chinese.rules.cardinal import Cardinal
...
class Math(Processor):
    ...
    def build_tagger(self):
        operator = string_file(get_abs_path("tn/chinese/data/math/operator.tsv"))
        unambiguous_operator = string_file(get_abs_path("tn/chinese/data/math/operator_unambiguous.tsv"))
